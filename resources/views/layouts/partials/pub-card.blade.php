<div class="col-md-6 pub-card-container">
    <div class="card">
        <img
            class="card-image-top"
            src="{{ asset('img/12e95557831581.59e5bb448a875-min.jpg') }}"
...
<div class="col-md-6 pub-card-container">
    <div class="card">
        <img
            class="card-image-top"
            src="{{ asset('img/5b65f67a7b5c1779fc482c7078c1-1455417.jpg!d-min.jpeg') }}"
        ...
        <div class="card-body">
            ...
            <p class="card-text">
                ...
                <a class="card-link pub-link pub-link-tel" href="tel:+447956694595">
...
<div class="col-md-6 pub-card-container">
    <div class="card">
        <img
            class="card-image-top"
            src="{{ asset('img/45739297102_5e280cfacc_z-min.jpg') }}"
